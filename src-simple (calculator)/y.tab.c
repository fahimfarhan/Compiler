...
{
  "$end", "error", "$undefined", "NEWLINE", "NUMBER", "ADDOP", "MULOP",
  "LPAREN", "RPAREN", "$accept", "input", "line", "expr", "term", "factor", YY_NULLPTR
};
#endif
